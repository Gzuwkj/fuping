...
def process(record: Person):
    ...
    if record.objectInfo['户类型'] == '脱贫户' and record.objectInfo['享受特困供养政策情况'] not in ['不享受',''] and howOld(record.objectInfo['证件号码']) and record.objectInfo['健康状况'] =='健康' and record.objectInfo['在校生状况'] == '':
